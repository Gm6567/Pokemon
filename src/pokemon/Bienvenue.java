...
public class Bienvenue extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(646, 395));
        setResizable(false);

        Bienvenue.setLayout(null);

        Jouer.setBackground(new java.awt.Color(255, 255, 255));
        Jouer.setFont(new java.awt.Font("Old English Text MT", 0, 36)); // NOI18N
        Jouer.setText("Jouer");
        ...
        Bienvenue.add(Jouer);
        Jouer.setBounds(210, 280, 220, 60);

        ImgFond.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pokemon/Pokemon.jpg"))); // NOI18N
        Bienvenue.add(ImgFond);
        ImgFond.setBounds(0, 0, 640, 360);

        jLabel2.setText("jLabel2");
        Bienvenue.add(jLabel2);
        jLabel2.setBounds(60, 110, 41, 16);

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Bienvenue, javax.swing.GroupLayout.DEFAULT_SIZE, 634, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Bienvenue, javax.swing.GroupLayout.PREFERRED_SIZE, 360, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void JouerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JouerActionPerformed
        Jeu f2 = new Jeu();
        f2.setVisible(true); // appelle une fenetre de nouveau jeu
